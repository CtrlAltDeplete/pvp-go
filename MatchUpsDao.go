...
func (dao *MatchUpsDao) FindSingleWhere(query string, params ...interface{}) (error, *MatchUpsDto) {
	var (
		id                                   int64
		cup                                  string
		matchUpType                          string
...
func (dao *MatchUpsDao) FindWhere(query string, params ...interface{}) []MatchUpsDto {
	var (
		matchUps                             []MatchUpsDto
		rows                                 *sql.Rows
		err                                  error
		id                                   int64
		cup                                  string
...
func (dao *MatchUpsDao) Create(cup, matchUpType string, pokemonId, matchUpOne, matchUpTwo, matchUpThree int64) (error, *MatchUpsDto) {
	var (
		result sql.Result
		err    error
		id     int64
...
func newMatchUp(id int64, cup string, matchUpType string, pokemonId, matchUpOne, matchUpTwo, matchUpThree int64) *MatchUpsDto {
	var matchUp = MatchUpsDto{}
	matchUp.SetId(id)
	matchUp.SetCup(cup)

...
func (dao *BattleSimulationsDao) FindSingleWhere(query string, params ...interface{}) (error, *BattleSimulationDto) {
	var (
		id                                          int64
		allyId                                      int64
		enemyId                                     int64
...
func (dao *BattleSimulationsDao) FindWhere(query string, params ...interface{}) []BattleSimulationDto {
	var (
		sims                                        = []BattleSimulationDto{}
		rows                                        *sql.Rows
		err                                         error
		id                                          int64
		allyId                                      int64
...
func (dao *BattleSimulationsDao) FindMatchupsForAlly(allyId int64, enemyIds []int64) []BattleSimulationDto {
	var (
		params []interface{}
		query  = "ally_id = ? " +
...
func (dao *BattleSimulationsDao) Create(allyId, enemyId int64, individualMatchups []int64) (error, *BattleSimulationDto) {
	var (
		result sql.Result
		err    error
		id     int64
	...
	score = CalculateTotalScore(individualMatchups)
...
func (dao *BattleSimulationsDao) BatchCreate(params []int64) {
	var (
		...
		query                      = "REPLACE INTO pvpgo.battle_simulations (ally_id, enemy_id, `0v0`, `0v1`, `0v2`, `1v0`, `1v1`, `1v2`, `2v0`, `2v1`, `2v2`, score) " +
			"VALUES "
	)
	...
	for i < len(params) {
		...
		query += fmt.Sprintf("(%d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d)", allyId, enemyId, zeroZero,
			zeroOne, zeroTwo, oneZero, oneOne, oneTwo, twoZero, twoOne, twoTwo, CalculateTotalScore([]int64{
...
func newBattleSimulation(id, allyId, enemyId int64, individualMatchups []int64) *BattleSimulationDto {
	var battleSim = BattleSimulationDto{}
	battleSim.SetId(id)

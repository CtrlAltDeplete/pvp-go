...
func (dao *RankingsDao) FindSingleWhere(query string, params ...interface{}) (error, *RankingDto) {
	var (
		id          int64
		cup         string
		pokemonId   int64
...
func (dao *RankingsDao) FindWhere(query string, params ...interface{}) []RankingDto {
	var (
		rankings    = []RankingDto{}
		rows        *sql.Rows
		err         error
...
func (dao *RankingsDao) Create(cup string, pokemonId int64, moveSetId int64, pokemonRank interface{},
	moveSetRank float64) (error, *RankingDto) {
	var (
		result sql.Result
		err    error
		id     int64
...
func newRanking(id int64, cup string, pokemonId int64, moveSetId int64, pokemonRank interface{}, moveSetRank float64) *RankingDto {
	var r = RankingDto{}
	r.SetId(id)
	r.SetCup(cup)

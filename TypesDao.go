...
func (dao *TypesDao) FindSingleWhere(query string, params ...interface{}) (error, *TypeDto) {
	var (
		id          int64
		firstType   string
...
func (dao *TypesDao) FindById(id int64) (error, *TypeDto) {
	var (
		query = "id = ?"
	)
...
func (dao *TypesDao) FindSingleByType(t string) (error, *TypeDto) {
	var (
		query = "first_type = ? " +
...
func (dao *TypesDao) FindSingleByTypes(t []string) (error, *TypeDto) {
	if len(t) == 1 {
...
func (dao *TypesDao) FindWhere(query string, params ...interface{}) []TypeDto {
	var (
		pokemonTypes = []TypeDto{}
		rows         *sql.Rows
		err          error
		id           int64
		firstType    string
...
func (dao *TypesDao) FindAllByType(t string) []TypeDto {
	var (
		query = "first_type = ? " +
			"OR second_type = ?"
	)
...
func (dao *TypesDao) FindAllByTypes(t []string) []TypeDto {
	var (
		params []interface{}
...
func (dao *TypesDao) FindAll() []TypeDto {
	var (
		pokemonTypes = []TypeDto{}
		rows         *sql.Rows
		e            error
...
func (dao *TypesDao) Create(firstType string, secondType interface{}) (error, *TypeDto) {
	var (
		displayName string
		result      sql.Result
		err         error
...
func (dao *TypesDao) Update(pokemonType TypeDto) {
	var (
		err   error
...
func (dao *TypesDao) Upsert(firstType string, secondType interface{}) (error, *TypeDto) {
	var (
		err         error
		pokemonType *TypeDto
...
func (dao *TypesDao) Delete(pokemonType TypeDto) {
	var (
		err   error
...
func newPokemonType(id int64, firstType string, secondType interface{}, displayName string) *TypeDto {
	var pt = TypeDto{}
	pt.SetId(id)

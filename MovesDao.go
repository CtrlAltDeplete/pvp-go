...
func (dao *MovesDao) FindSingleWhere(query string, params ...interface{}) (error, *MoveDto) {
	var (
		id                           int64
		name                         string
...
func (dao *MovesDao) FindById(id int64) (error, *MoveDto) {
	var (
		query = "id = ?"
	)
...
func (dao *MovesDao) FindByName(name string) (error, *MoveDto) {
	var (
		query = "name = ?"
	)
...
func (dao *MovesDao) FindWhere(query string, params ...interface{}) []MoveDto {
	var (
		moves                        = []MoveDto{}
		rows                         *sql.Rows
		e                            error
...
func (dao *MovesDao) FindByTypeId(id int64) []MoveDto {
	var (
		query = "type_id = ?"
	)
...
func (dao *MovesDao) FindByTypeIds(ids []int64) []MoveDto {
	var (
		id     int64
		params []interface{}
...
func (dao *MovesDao) FindAll() []MoveDto {
...
func (dao *MovesDao) Create(name string, typeId, power, turns, energy int64, probability, stageDelta, stats,
	target interface{}) (error, *MoveDto) {
	var (
		result sql.Result
		err    error
		id     int64
...
func (dao *MovesDao) Update(move MoveDto) {
	var (
		e     error
...
func (dao *MovesDao) Delete(move MoveDto) {
	var (
		e     error
...
func newMove(id int64, name string, typeId int64, power int64, turns int64, energy int64, probability interface{},
	stageDelta interface{}, stats interface{}, target interface{}) *MoveDto {
	var m = MoveDto{}
	m.SetId(id)
	m.SetName(name)
	m.SetTypeId(typeId)

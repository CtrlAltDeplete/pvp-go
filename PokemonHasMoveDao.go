...
func (dao *PokemonHasMoveDao) FindSingleWhere(query string, params ...interface{}) (error, *PokemonHasMoveDto) {
	var (
		id        int64
		pokemonId int64
		moveId    int64
...
func (dao *PokemonHasMoveDao) FindByPokemonAndMove(pokemonId, moveId int64) (error, *PokemonHasMoveDto) {
	var (
		query = "pokemon_id = ? " +
			"AND move_id = ?"
	)
...
func (dao *PokemonHasMoveDao) FindWhere(query string, params ...interface{}) []PokemonHasMoveDto {
	var (
		pokemonHasMoves = []PokemonHasMoveDto{}
		rows            *sql.Rows
		err             error
		id              int64
		pokemonId       int64
...
func (dao *PokemonHasMoveDao) FindAllByPokemonId(pokemonId int64) []PokemonHasMoveDto {
	var (
		query = "pokemon_id = ?"
	)
...
func (dao *PokemonHasMoveDao) Create(pokemonId, moveId int64, isLegacy bool) (error, *PokemonHasMoveDto) {
	var (
		result sql.Result
		err    error
		id     int64
...
func (dao *PokemonHasMoveDao) Update(pokemonHasMove PokemonHasMoveDto) {
	var (
		err   error
...
func (dao *PokemonHasMoveDao) Upsert(pokemonId, moveId int64, isLegacy bool) (error, *PokemonHasMoveDto) {
	var (
		err            error
		pokemonHasMove *PokemonHasMoveDto
	)
...
func (dao *PokemonHasMoveDao) Delete(pokemonHasMove PokemonHasMoveDto) {
	var (
		err   error
...
func newPokemonHasMove(id, pokemonId, moveId int64, isLegacy bool) *PokemonHasMoveDto {
	var phm = PokemonHasMoveDto{}
	phm.SetId(id)

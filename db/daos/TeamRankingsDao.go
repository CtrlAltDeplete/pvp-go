...
func (dao *TeamRankingsDao) FindSingleWhere(query string, params ...interface{}) (error, *dtos.TeamRankingDto) {
	var (
		id                                int64
		cup                               string
...
func (dao *TeamRankingsDao) FindWhere(query string, params ...interface{}) []dtos.TeamRankingDto {
	var (
		rankings                          []dtos.TeamRankingDto
		rows                              *sql.Rows
		err                               error
		id                                int64
		cup                               string
...
func (dao *TeamRankingsDao) Create(cup string, allyOneId, allyTwoId, allyThreeId int64, score float64) (error, *dtos.TeamRankingDto) {
	var (
		result sql.Result
		err    error
		id     int64
...
func newTeamRanking(id int64, cup string, allyOneId, allyTwoId, allyThreeId int64, score float64) *dtos.TeamRankingDto {
	var ranking = dtos.TeamRankingDto{}
	ranking.SetId(id)
	ranking.SetCup(cup)
